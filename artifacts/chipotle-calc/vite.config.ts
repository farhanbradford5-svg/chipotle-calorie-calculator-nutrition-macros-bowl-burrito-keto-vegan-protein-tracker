      ...
      transformIndexHtml: {
        ...
        handler(html, ctx) {
          ...
          const metaMap: Record<string, { title: string; description: string }> = {
            "/": {
              title: "Chipotle Calorie Calculator — Build Your Bowl | ChipotleCalc",
            ...
            "/menu/chips-sides": {
              title: "Chipotle Chips & Sides Calories | ChipotleCalc",
            ...
            "/diet/high-protein-chipotle": {
              title: "High Protein Chipotle Orders — Max Protein Builds | ChipotleCalc",
            ...
            "/diet/low-calorie-chipotle": {
              title: "Low Calorie Chipotle Orders — Under 400 Calories | ChipotleCalc",
            ...
            "/diet/vegetarian-chipotle": {
              title: "Vegetarian Chipotle Orders | ChipotleCalc",
            ...
            "/diet/low-carb-chipotle": {
              title: "Low Carb Chipotle Orders | ChipotleCalc",
            ...
            "/about": {
              title: "About ChipotleCalc — Free Chipotle Nutrition Calculator",
              description: "About ChipotleCalc. How we built the most accurate free Chipotle calorie calculator.",
            },
            "/methodology": {
              title: "Methodology — How ChipotleCalc Calculates Nutrition",
              description: "How ChipotleCalc calculates Chipotle nutrition values. Data sources, quantity modifiers, dietary badge criteria.",
            },
            "/editorial-policy": {
              title: "Editorial Policy — ChipotleCalc",
              description: "ChipotleCalc editorial policy covering data accuracy, update schedule, and corrections process.",
            },
            "/sources": {
              title: "Sources — ChipotleCalc Nutrition Data References",
              description: "Data sources used by ChipotleCalc including Chipotle official nutrition data and USDA references.",
            },
            "/faq": {
              title: "FAQ — Chipotle Nutrition Questions Answered | ChipotleCalc",
              description: "Frequently asked questions about Chipotle nutrition, calories, protein, and ordering for specific diets.",
            },
            "/privacy-policy": {
              title: "Privacy Policy — ChipotleCalc",
              description: "ChipotleCalc privacy policy. How we handle your data.",
            },
            "/terms-of-service": {
              title: "Terms of Service — ChipotleCalc",
              description: "ChipotleCalc terms of service.",
            },
          };
