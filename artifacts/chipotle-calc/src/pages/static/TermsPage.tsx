  ...
  return (
    <Layout>
      <SeoHead
        ...
        description="Terms of service for ChipotleMacros. Acceptance, accuracy, intellectual property, and liability."
      ...
      <article className="mx-auto max-w-3xl px-4 py-10 prose prose-gray">
        ...
        <p>
          By accessing or using ChipotleMacros at chipotlemacros.com ("the Site"), you agree to
        ...
        <p>
          ChipotleMacros is a free, browser-based nutrition calculator that helps users estimate
        ...
        <p>
          Nutrition values shown in ChipotleMacros are based on Chipotle's publicly available
        ...
        <p>
          ...
          consult chipotle.com directly. ChipotleMacros is not a substitute for the official
          Chipotle nutrition source.
        </p>
        <p>
          Nothing on ChipotleMacros constitutes medical, dietary, or health advice. If you
        ...
        <p>
          All original content on ChipotleMacros — including written guides, UI design, code,
          and editorial copy — is the intellectual property of ChipotleMacros and its operators.
        ...
        <p>
          ...
          Chipotle Mexican Grill, Inc. ChipotleMacros is not affiliated with, sponsored by,
        ...
        <p>
          You may use ChipotleMacros for personal, non-commercial meal planning and nutritional
        ...
        <ul>
          ...
          <li>
            Republishing, reselling, or redistributing ChipotleMacros content — including
        ...
        <p>
          ...
          ChipotleMacros and its operators expressly disclaim all warranties, whether express,
        ...
        <p>
          To the fullest extent permitted by applicable law, ChipotleMacros and its operators
