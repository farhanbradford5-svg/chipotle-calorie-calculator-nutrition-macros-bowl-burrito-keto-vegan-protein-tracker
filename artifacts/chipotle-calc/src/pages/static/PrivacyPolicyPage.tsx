  ...
  return (
    <Layout>
      <SeoHead
        ...
        description="ChipotleCalc privacy policy. How we handle user data, cookies, and analytics."
      ...
      <article className="mx-auto max-w-3xl px-4 py-10 prose prose-gray">
        ...
        <p>
          ChipotleCalc ("we", "our", or "the site") is an independent, browser-based nutrition
        ...
        <p>
          ChipotleCalc does not collect any personally identifiable information. We do not ask
        ...
        <p>
          ...
          None of this data is transmitted to any server operated by ChipotleCalc. We have no
          database of user meals or user profiles.
        </p>

        <h2>Browser Local Storage</h2>
        <p>
          To improve your experience, ChipotleCalc saves certain data to your browser's local
        ...
        <p>
          ...
          data or local storage for chipotlecalc.com. Clearing this data will remove your saved
          meals and macro goals from the device.
        </p>

        <h2>Cookies</h2>
        <p>
          ChipotleCalc itself does not set cookies for tracking or identification purposes.
          The core calculator functionality relies on local storage as described above, not
          on cookies.
        </p>
        <p>
          However, ChipotleCalc plans to integrate third-party services that may set their
        ...
        <p>
          ...
          ChipotleCalc. Google Analytics collects anonymized usage data including pages
        ...
        <p>
          ChipotleCalc does not knowingly collect personal information from children under the
          ...
          contact@chipotlecalc.com and we will promptly delete it.
        </p>

        <h2>Your Rights</h2>
        <p>
          Because ChipotleCalc does not collect or store personal data, there is generally
        ...
        <p>
          ChipotleCalc may contain links to external websites such as chipotle.com or
          google.com for reference purposes. We are not responsible for the privacy practices
          of those sites. This policy applies only to chipotlecalc.com.
        </p>
        ...
        <p>
          ...
          ChipotleCalc is an independent third-party tool.
        </p>
