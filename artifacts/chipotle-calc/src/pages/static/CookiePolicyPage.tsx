...
export default function CookiePolicyPage() {
  return (
    <Layout>
      <SeoHead
        title="Cookie Policy — ChipotleCalc"
        description="Cookie policy for ChipotleCalc. What cookies and local storage are used and how to control them."
      ...
      <article className="mx-auto max-w-3xl px-4 py-10 prose prose-gray">
        ...
        <p>
          This Cookie Policy explains how ChipotleCalc uses cookies and similar browser storage
        ...
        <p>
          ChipotleCalc does not currently set any first-party cookies for tracking,
        ...
        <p>
          ChipotleCalc uses browser <strong>local storage</strong> to improve your experience.
        ...
        <p>
          ...
          site data for chipotlecalc.com in your browser settings.
        </p>

        <h2>Third-Party Cookies — Google Analytics (Planned)</h2>
        <p>
          ChipotleCalc intends to enable Google Analytics 4 to understand how visitors
        ...
        <p>
          ChipotleCalc plans to display advertising through Google AdSense. When AdSense
        ...
        <p>
          You can clear all data stored by ChipotleCalc through your browser settings:
        </p>
        <ul>
        ...
        <p>
          Clearing cookies and local storage for ChipotleCalc will remove your saved meals
